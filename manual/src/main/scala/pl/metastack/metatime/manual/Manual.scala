...
object Manual extends App with Shared {
  ...
  val meta = Meta(
    date = DateTime.now(),
    title = "MetaTime User Manual v" + BuildInfo.version,
    author = "Tim Nieradzik",
    affiliation = "MetaStack Sp. z o.o.",
    `abstract` = "Time formatting library for Scala and Scala.js",
    language = "en-GB",
    url = "",
    editSourceURL = Some("https://github.com/MetaStack-pl/MetaTime/edit/master/"))
  ...
  val rawTrees = Seq(
    "introduction", "type-safe-dsl", "scheduler",
    "datetime-formatting", "scalajs-support", "development", "support"
